...
window.BB_I18N = {
  zh: {
    ...
    "effect.c3.h": "攔網不受影響",
    "effect.c3.p": "經攔網的球不受三米線限制，落在前區照樣得分。敢攔、攔得到，就有回報。",
    "effect.c4.h": "沒有前後排，人人可攻",
    "effect.c4.p": "人數少到不需要輪轉，也就沒有前排後排之分：任何人、在任何位置都可以起跳攻擊。這就是「我就自由」。",
    "effect.c5.h": "要守的範圍其實變小了",
    "effect.c5.p": "三米線內不必再防守，兩三個人真正要顧的只剩後場那 54 平方公尺，而不是整整 81 平方公尺。",
  ...
  en: {
    ...
    "effect.c3.h": "Blocking is unaffected",
    "effect.c3.p": "A ball off a block isn't bound by the 3 m line — land it in the front zone and it still scores. Commit to the block and you get paid for it.",
    "effect.c4.h": "No front row, no back row",
    "effect.c4.p": "With too few players to rotate, the front-row/back-row distinction disappears: anyone can attack from anywhere on the court. That is the \"I'm free\" in the slogan.",
    "effect.c5.h": "There's actually less to defend",
    "effect.c5.p": "Nobody has to cover the front zone any more, so two or three players are really defending the 54 m² of back court rather than the full 81 m².",
