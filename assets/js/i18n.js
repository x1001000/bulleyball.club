...
window.BB_I18N = {
  zh: {
    ...
    "effect.c3.h": "攔網重新值錢",
    "effect.c3.p": "經攔網的球不受三米線限制，落在前區照樣得分。敢攔、攔得到，就有回報——網前的正面對決重新變得值得。",
  ...
  en: {
    ...
    "about.name.zh": "\"今晚打牛排嗎？\" — literally, \"fancy some steak tonight?\" If you know, you know.",
    ...
    "effect.c3.p": "A ball off a block isn't bound by the 3 m line — land it in the front zone and it still scores. Commit to the block and you get paid for it, so the duel at the net is worth contesting.",
